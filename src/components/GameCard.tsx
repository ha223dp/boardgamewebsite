...
const GameCard: React.FC<GameCardProps> = ({ game, onGameClick }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-4 border-amber-200 overflow-hidden group">
